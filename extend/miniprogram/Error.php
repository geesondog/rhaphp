...
class Error
{
     ...
     * @var int || string
     */
    public static $signNoMatching = -10001;
    public static $signNoMatchingMsg = '签名不匹配,请检查！';
    public static $IllegalIv = -10002;
    public static $IllegalIvMsg = 'iv是不合法的';
    public static $decryptNoData = -10003;
    public static $decryptNoDataMsg = '解密信息为空，请检查参数准确性';
    public static $appidNoMatching = -10004;
    public static $appidNoMatchingMsg = '不合法的appid';
    public static $decryptAESError= -10005;
    public static $decryptAESErrorMsg= 'AES解密失败';
    public static $decryptPKCS7error = -10006;
    public static $decryptPKCS7errorMsg = 'PKCS7解密失败';
    public static $ValidAppidError = -10007;
    public static $ValidAppidErrorMsg = '校验AppID失败，AppID不匹配';
    public static $checkSignaturError =-10008;
    public static $checkSignaturErrorMsg = '检验signature失败';

    /**
     * 微信官方错误代码与内容
     * @return array
     */
    static public function globalCodes()
    {
        return [
            '-1' => '系统繁忙，此时请开发者稍候再试',
            '0' => '请求成功',
